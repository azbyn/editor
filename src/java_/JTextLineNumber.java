...
// TODO
public abstract class JTextLineNumber extends JPanel
     ...
     */
    public JTextLineNumber(JTextPane component) { this(component, 3); }
    ...
    private void setPreferredWidth() {
        ...
        Font font = new Font(componentFont.getFamily(), Font.BOLD,
                             componentFont.getSize());

        Element root = component.getDocument().getDefaultRootElement();
        int lines = root.getElementCount();
        int digits =
                Math.max(String.valueOf(lines).length(), minimumDisplayDigits);
    ...
    public void paintComponent(Graphics g) {
        ...
        int endOffset =
                component.viewToModel(new Point(0, clip.y + clip.height));
        g2d.setFont(font);
